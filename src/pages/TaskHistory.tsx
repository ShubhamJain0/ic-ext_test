...
import { getRecentActivities } from '../utils/apis';
...
export const TaskHistory = () => {
  ...
  useEffect(() => {
    //call recent activity api and set on success
    (async () => {
      ...
      <div className="xl:px-[100px] px-[40px] max-w-[1440px] mx-auto w-full">
        ...
        <div className="relative mt-[76px] mb-[172px]">
          <div className="flex px-[32px] items-center">
            <div>
              <Header content="Optimization task history" />
              <div className="mt-[12px]">
                <BodyText
                  content="Review your task history and data savings."
                  opacity="opacity-70"
                />
              </div>
            </div>
          ...
          <div className="bg-[#131B2D] p-[40px] rounded-[36px] rounded-br-[0px] mt-[30px] border-[#DADCF633] border-[1px]">
            {!recentActivity.length ? (
              <div className="p-[100px] rounded-[12px] rounded-br-[0px] mt-[40px] flex flex-col items-center">
